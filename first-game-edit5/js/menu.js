var menuState = {
	create: function(){
		...
		game.add.tween(nameLabel).to({y: 80}, 800).easing(Phaser.Easing.Bounce.Out).start();
		
		
		var scoreLabel = game.add.text(game.width/2,  game.height/2, 'Highscore: ' + game.global.score, {font: '25px Arial', fill: '#ffffff'});
